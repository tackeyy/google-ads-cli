# Contributing to Google Ads CLI

Thank you for your interest in contributing to Google Ads CLI! This document provides guidelines and
instructions for contributing to the project.

## 🙏 Welcome!

Google Ads CLI is a CLI tool for managing Zoom meetings via Server-to-Server OAuth. We welcome
...
- ✨ **Adding new features** - Expand Google Ads CLI's capabilities (discuss first!)
...
git clone https://github.com/YOUR_USERNAME/google-ads-cli.git
cd google-ads-cli
...
- 💬 **Questions** - Open a [GitHub Discussion](https://github.com/tackeyy/google-ads-cli/discussions)
- 🐛 **Bug Reports** - Open an [Issue](https://github.com/tackeyy/google-ads-cli/issues/new?template=bug_report.yml)
- 💡 **Feature Requests** - Open an [Issue](https://github.com/tackeyy/google-ads-cli/issues/new?template=feature_request.yml)
- ❓ **General Questions** - Open an [Issue](https://github.com/tackeyy/google-ads-cli/issues/new?template=question.yml)
...
Thank you for contributing to Google Ads CLI! Your efforts help make this tool better for everyone.
