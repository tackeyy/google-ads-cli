...
tests/
  unit/
    client.test.ts          # GadsConfig / maskToken のユニットテスト
    budget-check.test.ts    # checkBudgets ロジックのユニットテスト
```
...
2. Ask in [GitHub Discussions](https://github.com/tackeyy/google-ads-cli/discussions)
